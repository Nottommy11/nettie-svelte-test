<script>
	...
	import fund1 from '../data/fundamental questions - T1.json';
	import fund2 from '../data/fundamental questions - T2.json';
	import mod1 from '../data/mod1-multiAnswer.json';
	import mod1SA from '../data/mod1-singleAnswer.json';
	import mod3 from '../data/mod2-singleAnswer.json';

	const questions = mod3.map((question) => {
		return {
